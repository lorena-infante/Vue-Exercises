...
export default {
  data(){
    return {
      ...
      //for a single checkbox, we have a boolean
      userName: '',
      userAge: null,
      referrer: 'wom',
      interest: [],
  ...
  methods:{
    submitForm(){
      ...
      this.userName = '';
      //Age is being converted as number in vue (but whrn type=number), 
      //it's automatically converted, using v-model. But using $refs, it will not
      //be converted it has to be parsed manually.
